...
public class ModelQuestion {
    private String question_title, question_text, username_text, time_posted_text;

    public ModelQuestion(String question_title, String question_text, String username_text, String time_posted_text) {
